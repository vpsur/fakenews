...
modelo        = joblib.load(os.path.join(MODELS_DIR, "lr_pipeline.pkl"))
tfidf_title   = joblib.load(os.path.join(MODELS_DIR, "tfidf_title.pkl"))
tfidf_content = joblib.load(os.path.join(MODELS_DIR, "tfidf_content.pkl"))
